...
public class TextResourceIT {
	...
	public void testSaveText() throws Exception {
		...
		expect().
			statusCode(200).
			body(StringContains.containsString(MASHAPE_PUBLIC_USER_ID + ":2c7c3d5f244f1a40069a32224215e0cf9b42485c99d80f357d76f006359c7a18")).
		when().
			post("/text");
	}
	...
	public void testGetNamed() throws Exception {
		...
		expect().
			...
			body(StringContains.containsString(MASHAPE_PUBLIC_USER_ID + ":2c7c3d5f244f1a40069a32224215e0cf9b42485c99d80f357d76f006359c7a18")).
		when().
			get("/text/" + MASHAPE_PUBLIC_USER_ID + ":2c7c3d5f244f1a40069a32224215e0cf9b42485c99d80f357d76f006359c7a18");
	}
	...
	public void testGetMetrics() throws Exception {
		...
		when().
			get("/text/" + MASHAPE_PUBLIC_USER_ID + ":2c7c3d5f244f1a40069a32224215e0cf9b42485c99d80f357d76f006359c7a18" + "/metrics");
	}
	...
	public void testGetNamedMetrics() throws Exception {
		...
		expect().
			...
			body(StringContains.containsString("370.00")).
		when().
			get("/text/" + MASHAPE_PUBLIC_USER_ID + ":2c7c3d5f244f1a40069a32224215e0cf9b42485c99d80f357d76f006359c7a18" + "/metrics/CHARACTERS");
	}
